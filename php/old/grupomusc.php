...
<div class="container animado">
    <h4 class="tituloPagina">Grupos Musculares</h4>
    <div class="input-group input-group-md mb-3 pt-3">
        ...
        <button id="cadastrar" class="btn btn-outline-info mr-5 ml-5 mb-2" data-toggle="modal" data-target="#cadastroGrupoMusc">Cadastrar</button>
        <?php require_once 'modCadastroGrupoMusc.php'; ?>
...
<script type="text/javascript">
    ...
    $('#editarGrupoMusc').on('show.bs.modal', function(event) {
